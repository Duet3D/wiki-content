...
* Download the [USB drivers for Duet here](https://github.com/Duet3D/RepRapFirmware/blob/HEAD/Driver/){target=_blank} and extract the files to a suitable location. 
