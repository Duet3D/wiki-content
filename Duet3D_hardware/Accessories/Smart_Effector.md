...
In order to manipulate sensitivity with DuetWiFi (and perhaps other Duet boards) special sensitivity pin should be declared in M558 as C"zprobe.in+zprobe.mod".
