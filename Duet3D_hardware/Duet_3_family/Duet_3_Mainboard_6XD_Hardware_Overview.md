...
| ^^ | OUT 5 | out5 | ^^ |
| ^^ | ^^ | out5.tach | ^^ |
| Outputs (2-pin) | OUT 6 | out6| Fans, pumps. 2A limit per pin on VIN, 3A limit per bank of 3. There is a 800mA limit total on internal 12V |
| ^^ | OUT 7 | out7 | ^^ |
| ^^ | OUT 8 | out8 | ^^ |
...
OUT_0 to OUT_8 are all PWM-capable. See tables above for notes on voltage selection and current limits.
