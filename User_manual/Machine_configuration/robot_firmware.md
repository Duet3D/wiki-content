...
The left upper 3x3 matrix represents rotations and the result is the orientation of the result. The right column 1x3 vector is the translation and the result is the position.
