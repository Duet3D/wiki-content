...
means third stepper driver axis named A is mapped to DH parameter D1:4dhparameters. The letter drives the Dn Z axis (in the example: C axis changes the rotation matrix defined by D2). This allows deviating from the default "base is D0, first axis is D1, second D2 etc.". Letters IJK have a special meaning as tool vector, definition is by two letters of drive number and I/J/K. Default is 0X1:1Y2:2Z3:3A4:4B5:5C6 of a 6 axis robot and abbreviated for less axes.
