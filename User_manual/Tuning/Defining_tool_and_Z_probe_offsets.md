...
* On a tool changing 3D printer or CNC machine, you would normally choose some part of the tool pickup head to be the HRP. If the tool pickup head incorporates a Z probe (e.g. as on the E3D Tool Changer) then you might choose the position of the Z probe when it triggers to be the HRP.
