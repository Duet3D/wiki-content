...
* **For Ethernet Duets:** A network which includes an Ethernet switch or hub with a free port. Alternatively a network cable can be used directly between a computer and the Duet 2 Ethernet. 
  * If a cable is used to link the Duet 2 Ethernet directly to a computer then the computer network interface must support [Auto MDI-X](https://en.wikipedia.org/wiki/Medium-dependent_interface#Auto_MDI-X) or an Ethernet crossover cable is required.
