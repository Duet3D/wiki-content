...
RepRapFirmware 2.x and 1.x are no longer developed. The last versions (dated 02/2020) are RepRapFirmware 2.05.1 and RepRapFirwmare 1.26.1, and are available [here](https://github.com/Duet3D/RepRapFirmware/releases/tag/2.05.1).
