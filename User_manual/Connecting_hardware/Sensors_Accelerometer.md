...
**RRF 3.4** added support for the LIS3DSH (note the extra S). Connection via SPI and configuration are exactly the same as for the LIS3DH. Compared to the LIS3DH, the LIS3DSH has higher resolution, more convenient sampling rates, and produces a cleaner signal.

**RRF 3.5.0** added support for the LIS2DW12. Connection via SPI and configuration are exactly the same as for the LIS3DH/LIS3DSH. The LIS2DW12 is similar in performance to the LIS3DSH.
